	...
	<body>
		...
		<div id="show-chapter" class="content scaffold-show" role="main">
			...
			<ol class="property-list chapter">
				...
				<g:if test="${chapterInstance?.members}">
				<li class="fieldcontain">
					<span id="members-label" class="property-label"><g:message code="chapter.members.label" default="Members" /></span>
			...
			<g:form url="[resource:chapterInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${chapterInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
